...
const Home = ({setScreen}) => {
    ...
    return(
        <motion.div 
            className="home w-full h-full p-[10px] bg-slate-50 bg-opacity-[0.1]  rounded-[10px] gap-10 flex flex-col justify-center"
        ...
        >
            <h6>ABOUT ME</h6>
            <img src={photo} alt='me'  className='rounded w-full max-w-[1300px] max-h-[70vh]  mx-auto ' />
            <p className=" opacity-80 max-w-[1000px] text-center  mx-auto ">
            ...
            <img src={arrow_icon} alt='arrow' className='absolute top-[-18px] left-1/2 transform -translate-x-1/2 rotate-90 y_up_array_animate' />
            ...
            <img src={arrow_icon} alt='arrow' className='absolute bottom-[-18px] left-1/2 transform -translate-x-1/2 rotate-[-90deg] y_down_array_animate' />
        </motion.div>        
    );
};
